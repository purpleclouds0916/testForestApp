...
const TreeHeightGrowthDescription: VFC = React.memo(() => (
  <>
    ...
    例：高知県におけるスギの3等地 <TeX>{String.raw`a`}</TeX>:62.37996,{' '}
    ...
    <TeX>{String.raw`b`}</TeX>:0.01360:, <TeX>{String.raw`c`}</TeX>:0,{' '}
    <TeX>{String.raw`d`}</TeX>:0.92438
  </>
));
